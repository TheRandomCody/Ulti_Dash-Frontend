...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    try {
        ...
        if (!userResponse.ok || !guildsResponse.ok) {
            // Profile details might fail if the user is new, so we don't check it here
        ...
        if (profileDetailsResponse.ok) {
            ...
            banCount = profileDetails.banCount;
            verificationLevel = profileDetails.isStripeVerified ? 'Verified' : 'Unverified';
        }
            ...
            <div class="flex flex-col md:flex-row items-center gap-6">
                ...
                <div class="flex-1">
                    ...
                    <div class="flex flex-wrap gap-4 mt-4 text-sm">
                        ...
                        <div class="bg-gray-700 p-2 rounded-md"><strong>Bans in Network:</strong> ${banCount}</div>
                        <div class="bg-gray-700 p-2 rounded-md"><strong>Verification Level:</strong> ${verificationLevel}</div>
                    </div>
                </div>
